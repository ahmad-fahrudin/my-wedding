...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="{{ asset('love-love/assets/images/favicon.png') }}">
    <title> LoveLove - Wedding & Wedding Planner HTML5 Template</title>
    <link href="{{ asset('love-love/assets/css/themify-icons.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/font-awesome.min.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/flaticon.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/magnific-popup.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/animate.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/owl.carousel.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/owl.theme.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/slick.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/slick-theme.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/swiper.min.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/nice-select.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/owl.transitions.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/jquery.fancybox.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/odometer-theme-default.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/css/jquery-ui.css') }}" rel="stylesheet">
    <link href="{{ asset('love-love/assets/sass/style.css') }}" rel="stylesheet">
</head>
...
<body>
                            ...
                            <div class="portfolio-grids gallery-container clearfix">
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="assets/images/portfolio/18.jpg" class="fancybox" data-fancybox-group="gall-1">
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="assets/images/portfolio/19.jpg" class="fancybox" data-fancybox-group="gall-1">
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="assets/images/portfolio/21.jpg" class="fancybox" data-fancybox-group="gall-1">
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="assets/images/portfolio/20.jpg" class="fancybox" data-fancybox-group="gall-1">
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="assets/images/portfolio/22.jpg" class="fancybox" data-fancybox-group="gall-1">
    ...
    ================================================== -->
    <script src="{{ asset('love-love/assets/js/jquery.min.js') }}"></script>
    <script src="{{ asset('love-love/assets/js/bootstrap.bundle.min.js') }}"></script>
    <!-- Plugins for this template -->
    <script src="{{ asset('love-love/assets/js/modernizr.custom.js') }}"></script>
    <script src="{{ asset('love-love/assets/js/jquery.dlmenu.js') }}"></script>
    <script src="{{ asset('love-love/assets/js/jquery-plugin-collection.js') }}"></script>
    <!-- Custom script for this template -->
    <script src="{{ asset('love-love/assets/js/script.js') }}"></script>
</body>
