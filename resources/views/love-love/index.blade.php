                                ...
                                <div id="navbar" class="collapse navbar-collapse navigation-holder">
                                    ...
                                    <ul class="nav navbar-nav mb-2 mb-lg-0">
                                        <li class="menu-item-has-children">
                                            <a href="#">Beranda</a>
                                            <ul class="sub-menu">
                                                <li><a href="index.html">Home Utama</a></li>
                                                <li><a href="index-2.html">Perencana Pernikahan</a></li>
                                                <li><a href="index-3.html">Beranda Pengumuman</a></li>
                                                <li><a href="index-4.html">Beranda Pernikahan</a></li>
                                                <li><a class="active" href="index-5.html">Pengumuman Pernikahan Asia / India</a></li>
                                                <li><a href="index-6.html">Perencana Pernikahan Asia / India</a></li>
                                                <li><a href="index-7.html">Pernikahan Muslim</a></li>
                                                <li><a href="index-8.html">Beranda Toko</a></li>
                                                <li><a href="index-9.html">Undangan Pernikahan</a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <div class="mini-cart-content">
                                            ...
                                            <div class="mini-cart-items">
                                                <div class="mini-cart-item clearfix">
                                                    ...
                                                    <div class="mini-cart-item-des">
                                                        <a href="shop.html">Gaun Pernikahan</a>
                                                ...
                                                <div class="mini-cart-item clearfix">
                                                    ...
                                                    <div class="mini-cart-item-des">
                                                        <a href="shop.html">Bunga Pengantin</a>
                                            ...
                                            <div class="mini-cart-action clearfix">
                                                ...
                                                <div class="mini-btn">
                                                    ...
                                                    <a href="cart.html" class="view-cart-btn">Lihat Keranjang</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="portfolio-grids gallery-container clearfix">
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="assets/images/portfolio/13.jpg" class="fancybox" data-fancybox-group="gall-1">
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="assets/images/portfolio/15.jpg" class="fancybox" data-fancybox-group="gall-1">
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="assets/images/portfolio/16.jpg" class="fancybox" data-fancybox-group="gall-1">
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="assets/images/portfolio/14.jpg" class="fancybox" data-fancybox-group="gall-1">
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="assets/images/portfolio/17.jpg" class="fancybox" data-fancybox-group="gall-1">
                                    ...
                                    <form method="post" class="contact-validation-active" id="contact-form-main">
                                        ...
                                        <div class="radio-buttons">
                                            <p>
                                                ...
                                                <label for="attend">Ya, saya akan hadir</label>
                                            </p>
                                            <p>
                                                <input type="radio" id="not" name="radio-group">
                                                <label for="not">Maaf, saya tidak bisa datang</label>
                                            </p>
                                        </div>
                                        <div>
                                            <select name="guest" class="form-control">
                                                <option disabled="disabled" selected>Jumlah Tamu</option>
                                                <option>01</option>
                                                <option>02</option>
                                                <option>03</option>
                                                <option>04</option>
                                        ...
                                        <div>
                                            <input type="text" class="form-control" name="what" id="what" placeholder="Apa yang akan Anda hadiri">
                                        </div>
                                        <div>
                                            <select name="meal" class="form-control last">
                                                <option disabled="disabled" selected>Preferensi Makanan</option>
                                                <option>Sup Ayam</option>
                                                <option>Kebab Daging Kambing</option>
                                                <option>BBQ Ayam</option>
                                                <option>Salad Campur</option>
                                                <option>Ribs Daging Sapi</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="clearfix error-handling-messages">
                                            <div id="success">Terima kasih</div>
                                            <div id="error"> Terjadi kesalahan saat mengirim email. Silakan coba lagi nanti.
                                            </div>
                                        </div>
                                    </form>
                                </div>
        ...
        <section class="wpo-blog-section section-padding" id="blog">
            <div class="container">
                <div class="wpo-section-title">
                    ...
                    <h2>Baca Berita Pernikahan Kami</h2>
                </div>
                                ...
                                <div class="wpo-blog-grids gallery-container clearfix">
                                    <div class="grid">
                                        <div class="wpo-blog-item">
                                            ...
                                            <div class="wpo-blog-content">
                                                ...
                                                <h2><a href="blog.html">Fotografi adalah bagian penting dari pernikahan.</a></h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="grid">
                                        <div class="wpo-blog-item">
                                            ...
                                            <div class="wpo-blog-content">
                                                <h2><a href="blog.html">Gaun Pernikahan Terbaik untuk Hari Impian Anda</a></h2>
                                                <ul>
                                                    <li>22 Nov 2022</li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="grid">
                                        <div class="wpo-blog-item">
                                            ...
                                            <div class="wpo-blog-content">
                                                <h2><a href="blog.html">10 Ide Dekorasi Bunga Segar untuk Pernikahan.</a></h2>
                                                <ul>
                                                    <li>28 Nov 2022</li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="grid">
                                        <div class="wpo-blog-item">
                                            ...
                                            <div class="wpo-blog-content">
                                                <h2><a href="blog.html">Hadiah Pernikahan Terbaik yang Mungkin Anda Suka dan Pilih.</a></h2>
                                                <ul>
                                                    <li>25 Sep 2022</li>
                                                </ul>
                                            </div>
                    ...
                    <div class="col-12">
                        <div class="footer-link">
                            <ul>
                                ...
                                <li><a href="index-2.html">Pernikahan</a></li>
                                <li><a href="portfolio-grid.html">Portofolio</a></li>
