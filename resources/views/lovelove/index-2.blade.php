...
<body>
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="lovelove/images/slider/slide-5.jpg">
                        </div> <!-- end slide-inner -->
                    </div> <!-- end swiper-slide -->

                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="lovelove/images/slider/slide-6.jpg">
                        </div> <!-- end slide-inner -->
                    </div> <!-- end swiper-slide -->

                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="lovelove/images/slider/slide-7.jpg">
                        </div> <!-- end slide-inner -->
                    </div> <!-- end swiper-slide -->

                    <div class="swiper-slide">
                        <div class="slide-inner slide-bg-image" data-background="lovelove/images/slider/slide-8.jpg">
                        </div> <!-- end slide-inner -->
                    </div> <!-- end swiper-slide -->
                </div>
                <!-- end swiper-wrapper -->
        ...
        <section class="wpo-wedding-date">
            <div class="container">
                <h2 class="wow fadeInUp" data-wow-duration="1000ms">
                    <span class="shape-1"><img src="lovelove/images/slider/shape.png" alt=""></span>
                    Esabella & William
                    <span class="shape-2"><img src="lovelove/images/slider/shape2.png" alt=""> </span>
                </h2>
                    ...
                    <div class="row align-items-center">
                        <div class="col col-md-5 col-12">
                            <div class="couple-item wow fadeInLeftSlow" data-wow-duration="1700ms">
                                <div class="couple-img">
                                    <img src="lovelove/images/couple/img-1.png" alt="">
                                </div>
                        ...
                        <div class="col col-md-2 col-12">
                            <div class="middle-couple-shape wow fadeInUp" data-wow-duration="1000ms">
                                <div class="shape">
                                    <img src="lovelove/images/couple/shape.png" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col col-md-5 col-12">
                            <div class="couple-item wow fadeInRightSlow" data-wow-duration="1700ms">
                                <div class="couple-img">
                                    <img src="lovelove/images/couple/img-2.png" alt="">
                                </div>
                                <div class="couple-text">
                                    <h3>William Jack</h3>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna orci auctor vitae
        ...
        <section class="wpo-video-section-s2 pb-0 section-padding">
            ...
            <div class="container">
                <div class="video-wrap">
                    <img src="lovelove/images/cta2.jpg" alt="">
                    <a href="https://www.youtube.com/embed/OUB6zKc-Tos" class="video-btn" data-type="iframe"><i class="fi flaticon-play"></i></a>
                </div>
            </div>
        </section>
                    ...
                    <div class="wpo-story-item">
                        <div class="wpo-story-img-wrap">
                            ...
                            <div class="wpo-img-shape">
                                <img src="lovelove/images/story/shape.png" alt="">
                            </div>
                        </div>
    ...
    <script src="{{ asset('lovelove/js/jquery.dlmenu.js') }}"></script>
