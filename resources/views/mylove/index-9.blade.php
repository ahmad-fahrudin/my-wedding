...
<body>
    ...
    <div class="page-wrapper">
                                    ...
                                    <ul class="nav navbar-nav mb-2 mb-lg-0">
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li><a class="active" href="index-9.html">Home Video Banar</a></li>
        ...
        <!-- end of header -->
        <!-- start of hero -->
        <section class="wpo-hero-style-4">
            ...
            <div class="video-player" data-property="{videoURL:'https://www.youtube.com/watch?v=teLhLLlhfzc',containment:'.video-player',autoPlay:true, mute:true, startAt:0, opacity:1}"></div>
        </section>
        <!-- end of hero slider -->
