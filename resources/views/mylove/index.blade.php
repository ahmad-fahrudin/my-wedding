                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-2 col-md-6 col-6">
                                <div class="navbar-header">
                                    <a class="navbar-brand logo" href="index.html"><small>My</small>love<span><i class="fi flaticon-dove"></i></span></a>
                                </div>
                            </div>
        ...
        <footer class="wpo-site-footer">
                        ...
                        <div class="col col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                            <div class="widget about-widget">
                                <div class="widget-title">
                                    <a class="logo" href="index.html"><small>My</small>love<span><i class="fi flaticon-dove"></i></span></a>
                                </div>
            ...
            <div class="wpo-lower-footer">
                <div class="container">
                    <div class="row">
                        <div class="col col-xs-12">
                            <p class="copyright"> &copy; 2022 Mylove Template. Design By <a href="index.html">wpOceans</a>. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
