...
<body>
    ...
    <div class="page-wrapper">
                                    ...
                                    <ul class="nav navbar-nav mb-2 mb-lg-0">
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="index-5.html">Home Static Hero</a></li>
                                                <li><a href="index-10.html">Home Box Style</a></li>
                                                <li><a href="index-6.html">Home Ripple Effect</a></li>
                                                <li><a href="index-7.html">Home Sprite Effect</a></li>
                                                <li><a href="index-8.html">Home particles Effect</a></li>
                                                <li><a href="index-9.html">Home Video Banar</a></li>
                                                <li><a href="index-4.html">Invitation</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                        ...
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="gallery-s2.html">Gallery Style 2</a></li>
                                                <li><a href="gallery-slide.html">Gallery Slide</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                        ...
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="event.html">When & Where</a></li>
        ...
        <section class="wpo-hero-slider wpo-hero-style-3">
            <div class="wedding-announcement">
                <div class="couple-text">
                    <h2 class="wow slideInUp" data-wow-duration="1s">Margrate & Daniel</h2>
                    <p class="wow slideInUp" data-wow-duration="1.8s">We Are Getting Married Dec 8, 2022</p>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="couple-img">
                                            ...
                                            <div class="couple-shape">
                                                <img src="assets/images/couple/shape-3.png" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-7">
                            ...
                            <div class="couple-item groom">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-4 order-lg-2 order-1">
                                        <div class="couple-img">
                                            <img src="assets/images/couple/5.jpg" alt="">
                                            <div class="couple-shape">
            ...
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
                        <div class="clock-grids">
                            <div id="clock2"></div>
                            <div class="frame1"><img src="assets/images/countdown/frame1.png" alt=""></div>
                            <div class="frame2"><img src="assets/images/countdown/frame2.png" alt=""></div>
                            <div class="frame3"><img src="assets/images/countdown/frame3.png" alt=""></div>
                            <div class="frame4"><img src="assets/images/countdown/frame4.png" alt=""></div>
                        </div>
                    </div>
                </div>
            </div> <!-- end container -->
        ...
        <section class="story-section section-padding" id="story">
            ...
            <div class="shape-1">
                <div class="sticky-shape">
                    <img src="assets/images/story/shape-1.png" alt="">
                </div>  
            </div>
            <div class="shape-2">
                <div class="sticky-shape">
                    <img src="assets/images/story/shape-2.png" alt="">
                </div>
            </div>
        </section>
        <!-- end story-section -->
        ...
        <section class="wpo-contact-section-s2 section-padding" id="RSVP">
            <div class="container">
                <div class="wpo-rsvp-wrap">
                    <div class="row">
                        <div class="col-lg-8">
                    ...
                    <div class="right-img">
                        <img src="assets/images/rsvp/right.png" alt="">
                    </div>
                </div>
            </div>
            <div class="shape-1">
